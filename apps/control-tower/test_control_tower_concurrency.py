"""Safe-concurrency guard for the control-tower operator (parallel-execution migration, step 4).
...
_op = importlib.import_module("control-tower.operator").build_control_tower_operator()
...
def test_read_only_caps_declared():
    ...
    assert ro == ["bi.summary", "bi.ask", "bi.refresh"]
